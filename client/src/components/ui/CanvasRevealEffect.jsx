...
/**
 * CanvasRevealEffect — animated dot-matrix shader background.
 * Translated from the shadcn-style TSX component to plain JSX, no Tailwind.
 */
export default function CanvasRevealEffect({
  ...
  return (
    <div
      style={{ position: 'relative', height: '100%', width: '100%', ...containerStyle }}
    >
    ...
    for (const name in uniforms) {
      ...
      switch (u.type) {
        ...
        case 'uniform1i':
          ...
          break
        case 'uniform3f':
          prepared[name] = { value: new THREE.Vector3().fromArray(u.value), type: '3f' }
          break
        case 'uniform1fv':
        ...
        case 'uniform3fv':
          ...
          break
        case 'uniform2f':
          prepared[name] = { value: new THREE.Vector2().fromArray(u.value), type: '2f' }
          break
        default:
